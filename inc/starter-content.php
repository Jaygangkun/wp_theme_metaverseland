 ...
 *
 * Passes it through the `Metaverseland_starter_content` filter before returning.
 *
 * @since Metaverseland 1.0
 *
 * @return array A filtered array of args for the starter_content.
 */
function Metaverseland_get_starter_content() {
		...
		'posts'     => array(
			'front' => array(
				...
				'post_content' => '
					...
					<!-- wp:paragraph -->
					<p>' . esc_html_x( 'Metaverseland includes stylish borders for your content. With an Image block selected, open the "Styles" panel within the Editor sidebar. Select the "Frame" block style to activate it.', 'Theme starter content', 'twentytwentyone' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->
					...
					<!-- wp:paragraph -->
					<p>' . esc_html_x( 'Metaverseland also includes an overlap style for column blocks. With a Columns block selected, open the "Styles" panel within the Editor sidebar. Choose the "Overlap" block style to try it out.', 'Theme starter content', 'twentytwentyone' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns -->
	 ...
	 */
	return apply_filters( 'Metaverseland_starter_content', $starter_content );
}
