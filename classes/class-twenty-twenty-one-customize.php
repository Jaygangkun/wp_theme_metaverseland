...
if ( ! class_exists( 'Metaverseland_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Metaverseland 1.0
	 */
	class Metaverseland_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->register_control_type( 'Metaverseland_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Metaverseland_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
